...
# Определить сумму отрицательный элементов
"""
sum = 0
for i in range(int(input("Количество элементов: "))):
...
print(sum)
"""
# Определить минимальное значение среди положительных элементов
"""
min_z = None
for i in range(int(input("Количество элементов: "))):
    num = + int(input(f"Элемент номер {i + 1}: "))
...
# Определить образует ли элементы равномерно убывающие последовательность
"""
razn = None
tmp = None
for i in range(int(input("Количество элементов: "))):
...
# Определить второй минимальный элемент
